...
//  *
//  * @param v
//  *   seed, aka secret "sn9tYCjBpqXgHKwJeMT1LC4fdC17d",
//  */
...
//
///**
//  * Essentially like RipplePublicKey except for it can be empty string. If there
//  * is a failure in signing
//  *
//  * @param v
//  *   None is rendered as ""
//  */
...
//
//  /**
//    * Before trying to decode, replace "" with Json.Null which should be pased
//    * on None
//    */
...
//
//object Signer {
//  given dec: Decoder[Signer]          = Decoder.forProduct3("Account", "SigningPubKey", "TxnSignature")(Signer.apply)
//  given enc: Encoder.AsObject[Signer] =
